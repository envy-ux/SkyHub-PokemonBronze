...
## Load (after you push to GitHub)

```lua
loadstring(game:HttpGet("https://raw.githubusercontent.com/YOUR_USER/YOUR_REPO/main/SkyHub.lua"))()
```

Replace `YOUR_USER` / `YOUR_REPO` with your real GitHub path.  
Or paste the full `SkyHub.lua` into Delta for a local test.
...
| `loader.lua` | One-line loadstring helper |
| `README.md` | This file |
